...
//● table( ) metodu oluşturun //method olusturmadan devam ettik
...
//            ○ 4.satirdaki(row) elementleri konsolda yazdırın.
        List<WebElement> dorduncySatirElementleri = driver.findElements(By.xpath("//tbody//tr[4]//td"));
        dorduncySatirElementleri.stream().map(WebElement::getText).forEach(System.out::println);
