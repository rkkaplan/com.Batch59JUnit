...
public class C02_Alerts {
    ...
    public void acceptAlert(){
        ...
        String actualResult = driver.findElement(By.xpath("//*[text()='You successfully clicked an alert']")).getText();
    ...
    public void dismissAlertTest(){
        ...
        Assert.assertFalse(actualResult.contains(unexpectedWord));
